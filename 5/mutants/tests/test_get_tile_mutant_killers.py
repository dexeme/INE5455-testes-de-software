...
class TestGetTileEmptyPosition(unittest.TestCase):
    ...
    def test_get_tile_same_line_different_column_returns_tile_not_space(self):
        # Complementar: mesma linha do vazio, coluna diferente → deve retornar tile.
        result = self.game.get_tile(self.empty_line, 1)
        self.assertNotEqual(" ", result)
        self.assertEqual(1, result)
